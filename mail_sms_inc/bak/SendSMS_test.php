...
//$OP_RESULT = SEND_SMS("13911484765","【中交兴路监控平台】:测试 中交兴路监控平台各位领导客车平台出现异常情况!");
$OP_RESULT = SEND_SMS("13520181582","【中交兴路监控平台】:测试 中交兴路监控平台各位领导客车平台出现异常情况!");
//$OP_RESULT = SEND_SMS("13801035856","<From 21ViaNet> 192.168.111.181(chpt_m_01) : Swap SWAP OK - 100% free (4094 MB out of 4094 MB)");
echo $OP_RESULT;
#$OP_RESULT1 = SEND_SMS("18611153002","1<From 21ViaNet> 192.168.111.181(chpt_m_01) : Swap SWAP OK - 100% free (4094 MB out of 4094 MB)");
#echo $OP_RESULT1;
